...
export default async function AdminPdfCreditsPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const filteredCredits = credits.filter((credit) => {
    ...
    const health = ratio >= 0.9 ? "critical" : ratio >= 0.7 ? "warning" : "healthy";
