...
export function ActionCard({ action, userId, canWrite, studentView = false, activeLabId, meetingHref }: { action: MeetingActionRecord; userId: string; canWrite: boolean; studentView?: boolean; activeLabId?: string | null; meetingHref?: string }) {
