  ...
  return (
    <header className="border-b border-white/10 bg-slate-950/95 px-4 py-4 backdrop-blur">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4">
        ...
        <nav id="student-workspace-menu" aria-label="學生工作台導覽" className={`${menuOpen ? "absolute inset-x-4 top-[4.5rem] z-20 block" : "hidden"} min-w-0 flex-1 rounded-2xl border border-white/10 bg-slate-950 p-3 shadow-2xl shadow-black/30 md:static md:block md:border-0 md:bg-transparent md:p-0 md:shadow-none`}>
          <div className="flex flex-col gap-4 md:flex-col md:items-end lg:flex-row lg:items-center">
